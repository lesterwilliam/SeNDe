...
def search_and_destroy_file():
	...
	for root, dirs, files in os.walk("s:/"):
		for file in files:
			if file.endswith(".m3u") or file.endswith(".log") or file.endswith(".ini") or file.endswith(".sfv") or file.endswith(".pdf") or file.endswith(".txt") or file.endswith(".avi") or file.endswith(".JPEG") or file.endswith(".jpg") or file.endswith(".DS_Store") or file.endswith(".pls") or file.endswith(".dat") or file.endswith(".mp4") or file.endswith(".bmp") or file.endswith(".cue") or file.endswith(".accurip") or file.endswith(".wma") or file.endswith(".jpeg") or file.endswith(".m3u8") or file.endswith(".JPG") or file.endswith(".CUE") or file.endswith(".LOG") or file.endswith("Thumbs.db"):
